...
public class AdminAccountController {
    ...
    @PostMapping("/create")
    public ResponseEntity<?> createAccout(@Validated @RequestBody RegisterRequest registerRequest) {
        Authen.check();
    ...
    public ResponseEntity<?> updatePassword(@RequestParam("id")Long id,
        ...
        accountService.updatePassword(id, request.getStudentId(), request.getPassword());
